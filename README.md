...
<img src="assets/agent-security-hero.png" alt="agent-security — Vedic Arsenal by Darshankumar Joshi" width="100%" />
...
**Zero-dependency Python library for LLM agent agent-security**

[![Python](https://img.shields.io/badge/Python-3.8%2B-blue?style=flat-square&logo=python)](https://python.org)
[![Zero Dependencies](https://img.shields.io/badge/Dependencies-Zero-brightgreen?style=flat-square)](https://github.com/darshjme/agent-security)
[![Tests](https://img.shields.io/badge/Tests-Passing-success?style=flat-square)](https://github.com/darshjme/agent-security/actions)
...
`agent-security` implements **zero-dependency python library for llm agent agent-security**

Inspired by the Vedic principle of *रक्षा* (Raksha), this library brings the ancient wisdom of structured discipline to modern LLM agent engineering.
...
Or clone directly:
```bash
git clone https://github.com/darshjme/agent-security.git
cd agent-security
pip install -e .
```
...
```mermaid
flowchart LR
    A[Input] --> B[agent-security]
    B --> C{Process}
    C -- Success --> D[Output]
    C -- Error --> E[Handle / Retry]
    E --> B
    style B fill:#6b21a8,color:#fff
    note["Security — Zero Dependencies"]
```
...
Production LLM systems fail in predictable ways. `agent-security` solves the **security** failure mode with:
...
`agent-security` is part of **[darshjme/arsenal](https://github.com/darshjme/arsenal)** — a collection of 100 focused Python libraries for LLM agent infrastructure.

Each library solves exactly one problem. Together they form a complete stack.

```
pip install agent-security  # this library
